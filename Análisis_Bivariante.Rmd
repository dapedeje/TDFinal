...
ggplot(data = datos, aes(x = x, y = y, color = variable)) +
  geom_line() +
...
Cómo podemos observar el número de latidos por minuto del feto es mayor que el número de latidos de la madre.
