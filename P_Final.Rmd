...
```
Una vez tenemos esta información vamos a vizualizar las variables que tiene mucha relación.

```{r}
#Podemos ver en este gráfico, Pb y Ps siguen una distribución líneal,
#Esto es debido a lo dicho con anterioridad, que siempre ha de estar proporcionado
