...
```{r}
datos_comp1 <- Datos_Dig %>% gather(key = "variable", value = "value", -c("SPO2","VCP","Ps","Pd","Pm","tiempo","MHR"))
...
```
Podemos ver que los latidos estan practicamente sincronizados esto es gracias a un efecto neuroacústico. 
